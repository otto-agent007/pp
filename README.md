...
- current slice: no-provider contact readiness from the portal send/resend boundary proposal
- next candidates: provider-approved portal send/resend route and persistent portal token audit events
