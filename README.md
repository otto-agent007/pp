...
- Draft PR #99, Shared Compliance Review Items Safe Hook V1, is open on branch `codex/shared-compliance-review-items-safe-hook-v1`.
...
- Next candidates after PR #99 lands: inventory deep-linking from Chemical Product Binder or technician license/Branch credential tracking.
