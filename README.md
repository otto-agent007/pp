...
compliance live-state clarity, shared job schedule wall-clock labels across
admin/customer proof and billing surfaces, a shared mobile sync badge, and a
white app canvas from existing hook/runtime data and design tokens, without new
