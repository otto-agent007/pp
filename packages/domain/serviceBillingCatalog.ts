...
const serviceBillingOfferings = [
  offering({
    ...
    techBadgeLabel: "General Pest",
    techWorkflow: "general_service",
  }),
  offering({
  ...
  offering({
    ...
    defaultBillingDisposition: "included_in_recurring",
    defaultJobPurpose: "service",
    defaultServiceCadence: "bimonthly",
    family: "recurring_general_pest",
  ...
  offering({
    ...
    techBadgeLabel: "Inspection",
    techWorkflow: "inspection",
  }),
  offering({
  ...
  offering({
    ...
    techBadgeLabel: "Project Work",
    techWorkflow: "project",
  }),
  offering({
    closeoutGuidance: [
      "Confirm WDO report, findings, recommendations, and escrow document handoff before release.",
