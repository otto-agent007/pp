...
describe("compliance domain", () => {
  ...
  it.each([
    [
      ...
      "Compliance authority is invalid",
    ],
    [
      "jurisdiction",
      {
      ...
      "Compliance jurisdiction is invalid",
    ],
    [
      "workflow",
      {
      ...
      "Compliance workflow is invalid",
    ],
    [
      "retrieved_at",
      {
      ...
      "Retrieved at must be a valid date",
    ],
    [
      "review_status",
      {
      ...
      "Compliance review status is invalid",
    ],
    [
      "text_path",
      {
    ...
    "rejects invalid %s in source manifest entries",
    (_field, entry, message) => {
      expect(() =>
        validateComplianceSourceManifestEntry(entry as never),
      ).toThrow(message);
    },
  );
